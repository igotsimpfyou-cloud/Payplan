    ...
    <div className={`bg-white ${uiSpacing.card}`}>
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className={`text-slate-600 ${uiType.helperText}`}>
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-slate-50 rounded-xl">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className={`text-slate-600 ${uiType.helperText}`}>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl font-semibold transition-colors ${uiTap.control} ${
                stats.duplicateCount > 0
        ...
        {cleanupResult && (
          <div className="p-4 bg-green-50 border border-green-200 rounded-xl flex items-center gap-3">
            ...
            <span className={`text-green-700 font-medium ${uiType.helperText}`}>
        ...
        {/* Stats */}
        <div className={`text-slate-500 text-center ${uiType.helperText}`}>
  ...
  return (
    <div className={uiSpacing.pageStack}>
      ...
      <div className={`bg-white ${uiSpacing.card}`}>
        ...
        <div className="space-y-4">
          <div>
            <label className={`font-semibold text-slate-600 block mb-2 ${uiType.helperText}`}>
              Tabscanner API Key
            </label>
            <div className="flex gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  className={`w-full px-4 py-2 pr-10 border-2 rounded-xl ${uiTap.control}`}
                />
                <button
                  onClick={() => setShowApiKey(!showApiKey)}
                  className={`absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 ${uiTap.iconControl}`}
                >
              ...
              <button
                ...
                className={`px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-semibold ${uiTap.control}`}
              >
              ...
              {ocrApiKey && (
                <button
                  ...
                  className={`px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-xl font-semibold ${uiTap.control}`}
                >
                  Clear
                </button>
              )}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <p className={`text-blue-800 mb-2 ${uiType.helperText}`}>
              <strong>How to get a free API key:</strong>
            </p>
            <ol className={`text-blue-700 list-decimal list-inside space-y-1 ${uiType.helperText}`}>
            ...
            <a
              ...
              className={`inline-flex items-center gap-1 mt-3 text-blue-600 hover:text-blue-800 font-semibold ${uiType.helperText} ${uiTap.control}`}
            >
          ...
          {!ocrApiKey && (
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
              <p className={`text-emerald-800 ${uiType.helperText}`}>
          ...
          {ocrApiKey && (
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <p className={`text-green-800 ${uiType.helperText}`}>
      ...
      <div className={`bg-white ${uiSpacing.card}`}>
        ...
        <div className="space-y-4">
          <button
            ...
            className={`w-full px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-semibold flex items-center justify-center gap-2 transition-colors ${uiTap.control}`}
          >
            <Download size={18} />
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
            <p className={`text-slate-700 ${uiType.helperText}`}>
      ...
      <div className={`bg-white ${uiSpacing.card}`}>
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex-1 px-4 py-3 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2 ${uiTap.control}`}
          >
            <Download size={18} />
            Export Backup
          </button>
          <button
            ...
            className={`flex-1 px-4 py-3 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2 ${uiTap.control}`}
          >
            <Upload size={18} />
            Restore Backup
          </button>
        ...
        <div className="mt-4 bg-amber-50 border-2 border-amber-200 rounded-xl p-4">
          <p className={`text-amber-800 ${uiType.helperText}`}>
